...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_name' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'id' => ['type' => 'unique', 'columns' => ['id', 'post_id'], 'length' => []],
    ...
    public $records = [
        [
            ...
            'created_at' => '2015-10-15 13:44:31',
            'updated_at' => 1444916671
        ],
    ];
}
